...
export default function Home() {
  ...
  return (
    <div className="h-screen overflow-y-auto scroll-smooth relative bg-gradient-to-b from-white to-yellow-50 dark:bg-none dark:bg-[#070c2a]">
      ...
      <main className="relative max-w-5xl min-h-screen mx-auto flex flex-col justify-center gap-8 px-6 sm:px-8 py-12 sm:py-20">
        <div className="absolute z-0 top-0 left-[-15%] w-3/5 h-3/5 bg-gradient-to-t from-yellow-100 dark:from-cyan-600 to-transparent rounded-full filter blur-[160px] opacity-75"></div>
        ...
        <section className="usage relative z-10">
          ...
          <ol className="leading-[1.375] list-inside list-decimal text-sm sm:text-base text-left break-all font-[family-name:var(--font-geist-mono)]">
            <li className="mb-4 min-w-0">
              ...
              <ol className="pl-5 pl-6 list-inside list-disc text-sm text-left font-[family-name:var(--font-geist-mono)]">
                <li className="mb-1">
